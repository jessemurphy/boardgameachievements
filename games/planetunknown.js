...
// ── Planet Unknown ───────────────────────────────────────────
  {
    ...
    logFields: [
      ...
      { id: 'planet',      label: 'Planet',             type: 'select', options: ['Unknown','Advocate','Bastion','Clash','Doomed','Enigma','Frontier','Genesis','Horizon','Icarus','Jericho','Kronos','Luminary'] },
      { id: 'corporation', label: 'Corporation',        type: 'select', options: ['Unknown','Arid Corp','Dune Corp','Flux Group','Glacier Inc','Horizon Group','Oasis Corp','Pioneer Corp','Tempest Ltd'] },
    ...
    achievements: [
      ...
      { id: 'pu_allcorps', icon: '✨', tier: 'gold',   pts: 60,  name: 'Master of Corporations',
        ...
        check: { type: 'win_all_values', field: 'corporation', values: ['Arid Corp','Dune Corp','Flux Group','Glacier Inc','Horizon Group','Oasis Corp','Pioneer Corp','Tempest Ltd'] } },
