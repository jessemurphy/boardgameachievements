...
// ── Vantage ───────────────────────────────────────────────────
  {
    ...
    logFields: [
      ...
      { id: 'missionVictory', label: 'Mission Victory', type: 'toggle', trueLabel: 'Yes', falseLabel: 'No' },
      ...
      // ── Per-character card achievements ──
    ...
    customStats: [
      ...
      { label: 'Missions Completed',  type: 'count_toggle', field: 'missionVictory' },
    ...
    achievements: [
      ...
      { id: 'vt_jules_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Jules: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Jules, the Captain', field2: 'missionVictory', value2: 'true' } },
      ...
      { id: 'vt_soren_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Soren: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Soren, the Navigator', field2: 'missionVictory', value2: 'true' } },
      ...
      { id: 'vt_emilien_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Emilien: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Emilien, the Scholar', field2: 'missionVictory', value2: 'true' } },
      ...
      { id: 'vt_ira_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Ira: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Ira, the Medic', field2: 'missionVictory', value2: 'true' } },
      ...
      { id: 'vt_ariel_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Ariel: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Ariel, the Engineer', field2: 'missionVictory', value2: 'true' } },
      ...
      { id: 'vt_tina_mission',   icon: '🎖️', tier: 'bronze', pts: 5,  name: 'Tina: Mission Victory',
        ...
        check: { type: 'win_two_fields', field1: 'character', value1: 'Tina, the Marine', field2: 'missionVictory', value2: 'true' } },
